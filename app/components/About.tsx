      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-black/80">Navdeep Singh</span>
        ...
        <span
          ref={dontClickRef}
          className="absolute bottom-8 right-8 text-sm text-black/80 underline-offset-4 transition-all duration-300"
          style={{ opacity: 0 }}
        >
          Made To Amaze
        </span>
